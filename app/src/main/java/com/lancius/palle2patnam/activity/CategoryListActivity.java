...
public class CategoryListActivity extends AppCompatActivity {
    ...
    String catid, productId, product_id, productName, productPrice, productPriceId, productWeight, productWeightId, productImage, selected_weight, selected_price, categoryId, message;
    Toolbar toolbar;
...
//        db.deleteAll();
        ...
        bottomLayout = (RelativeLayout) findViewById(R.id.list_bottom_layout);
        bottomLayout.setVisibility(View.GONE);

        cart_list_count_txt = (TextView) findViewById(R.id.category_list_cart_count);
        cart_list_count_txt.setText("" + contacts.size());

        itemsCountTxt = (TextView) findViewById(R.id.category_list_items_count);
        itemsCountTxt.setText("" + contacts.size() + " item(s)");

        add_price = (TextView) findViewById(R.id.category_list_total_price);
        ...
        ImageView cart = (ImageView) findViewById(R.id.list_item_cart);
...
//                        showToast();
        ...
        protected void onPostExecute(String file_url) {
            ...
            listview = (GridView) findViewById(R.id.category_listview);
            ...
            if (!productsList.isEmpty()) {
                ...
                if (categoryId.equalsIgnoreCase("2") || categoryId.equalsIgnoreCase("4") || categoryId.equalsIgnoreCase("5")) {

                    TextView settv = (TextView) findViewById(R.id.coming_soon_txt);
                    settv.setText("Coming Soon....");
    ...
    public class CategoryDetailAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView,
            ...
            final View itemView = inflater.inflate(R.layout.product_list_item,
                    parent, false);
            ...
            category_product_price = (TextView) itemView
                    .findViewById(R.id.list_item_selling_price);
            category_product_weight = (TextView) itemView
                    .findViewById(R.id.list_item_weight);
            ...
            category_product_weight.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    product_id = resultp.get(CategoryListActivity.TAG_CATEGORY_PRODUCT_ID);
                    ...
                    product_price_listview.setOnItemClickListener(
                            new AdapterView.OnItemClickListener() {
                                public void onItemClick(AdapterView<?> parent, View view,
                                    ...
                                    ((TextView) itemView.findViewById(R.id.list_item_weight)).setText(selected_weight);
                                    ((TextView) itemView.findViewById(R.id.list_item_selling_price)).setText(selected_price);
            ...
            if (categoryIdList.contains(resultp.get(CategoryListActivity.TAG_CATEGORY_PRODUCT_ID))) {
                ...
                for (Category cn : contacts) {
                    ...
                    if (catid.equalsIgnoreCase(resultp.get(CategoryListActivity.TAG_CATEGORY_PRODUCT_ID))) {
            ...
            plus_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    product_id = resultp.get(CategoryListActivity.TAG_CATEGORY_PRODUCT_ID);
                    String imageView1 = resultp.get(CategoryListActivity.TAG_CATEGORY_PRODUCT_IMAGE);
            ...
            Glide.with(activity).load(resultp.get(CategoryListActivity.TAG_CATEGORY_PRODUCT_IMAGE))
                    .thumbnail(0.5f)
                    .crossFade()
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("product_id", resultp.get(CategoryListActivity.TAG_CATEGORY_PRODUCT_ID));
                    intent.putExtra("product_name", resultp.get(CategoryListActivity.TAG_CATEGORY_PRODUCT_NAME));
                    intent.putExtra("product_image", resultp.get(CategoryListActivity.TAG_CATEGORY_PRODUCT_IMAGE));
